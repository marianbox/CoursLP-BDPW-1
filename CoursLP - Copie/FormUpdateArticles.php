...
<html lang="en">
    ...
    <body>
        ...
        <div class="container px-4 px-lg-5">
            ...
            <!-- Content Row--> 
            <!-- Formulaire--> 
            <form method=POST id="articleForm" action='FormUpdateArticles.php' enctype="multipart/form-data">



            <!-- ID--> 
                <div class="mb-3">
                <label for="texte" class="form-label">ID</label>
                    <input type="text" name="id" class="form-control" id="texte" aria-describedby="emailHelp" value="<?= $a->getId();?>">
                ...
                <label for="texte" class="form-label">Titre</label>
                    <input type="text" name="titre" class="form-control" id="texte" aria-describedby="emailHelp" value="<?= $a->getTitre();?>">
                    <div id="emailHelp" class="form-text"></div>
                </div>
                ...
                <div class="input-group">
                    ...
                    <textarea class="form-control" name="texte" aria-label="With textarea">  <?= $a->getTexte();?>   </textarea> 
                </div>
                ...
                <div class="mb-3 form-check">
                   ...
                   <button type="submit" class="btn btn-primary" name="update" >modifier Mon Article</button>
