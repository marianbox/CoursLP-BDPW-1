                ...
                <div class="col-md-4 mb-5">
                    ...
                    <img class="card-img-top" src="img/<?= $articles->getId() ?>.jpg">
                        ...
                        <div class="card-footer">
                            <a class="btn btn-primary btn-sm" href="#!"><?=$articles->getDate();?></a>
                           
                           
                            <?php if(isset($_COOKIE['sid'])){?>
                                <a class="btn btn-primary btn-sm" href="FormUpdateArticles.php?formulaire=<?= $articles->getId(); ?>">Modifier</a><?php } ?>
